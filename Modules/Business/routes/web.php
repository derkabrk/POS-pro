...
Route::group(['as' => 'business.', 'prefix' => 'business', 'middleware' => ['users', 'expired']], function () {
    ...
    Route::get('confirmed-orders', [Business\AcnooSaleController::class, 'confirmedOrders'])->name('business.sales.confirmed');
    Route::get('sales/confirmed', [Business\AcnooSaleController::class, 'confirmedOrders'])->name('sales.confirmed');
