            ...
            <div class="card bg-light">
                <div class="card-body">
                    <div class="table-header d-flex justify-content-between align-items-center p-3">
                        ...
                        <a type="button" href="#category-create-modal"
                            class="btn btn-primary rounded-pill {{ Route::is('admin.categories.create') ? 'active' : '' }}"
                ...
                <div class="delete-item d-none">
                    <div class="d-flex justify-content-between align-items-center p-3">
                        ...
                        <button data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#multi-delete-modal" data-url="{{ route('business.categories.delete-all') }}">{{ __('Delete') }}</button>
                    </div>
                </div>
