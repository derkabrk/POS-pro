            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fw-semibold fs-15"> Web Apps <span class="badge bg-warning text-dark ms-2">Coming Soon...</span></h6>
                                </div>
                                <div class="col-auto">
                                    <!-- View All Apps button removed -->
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        @if(auth()->check() && method_exists(auth()->user(), 'unreadNotifications'))
                                            ...
                                            @if($unreadCount > 0 && Route::has('admin.notifications.mtReadAll'))
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    @if(auth()->check() && method_exists(auth()->user(), 'notifications') && auth()->user()->notifications->count() > 0)
                                    ...
                                    @else
                                        <div class="text-center text-muted py-4">
                                            ...
                                            <div>{{ __('No notifications found.') }}</div>
                                        </div>
                                    @endif
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    @if($messages->count() > 0)
                                        @foreach($messages as $notification)
                                            <div class="text-reset notification-item d-block dropdown-item position-relative @if(is_null($notification->read_at)) bg-light @endif">
                                                <div class="d-flex">
                                                    <img src="{{URL::asset('build/images/users/avatar-3.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="{{ route('admin.notifications.mtView', $notification->id) }}" class="stretched-link">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @else
                            <a class="dropdown-item" href="{{ route('business.settings.index') }}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        @endif
