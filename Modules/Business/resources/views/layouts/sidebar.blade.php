        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('productPermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.products.index', 'business.products.create', 'business.products.edit', 'business.categories.index', 'business.brands.index', 'business.units.index', 'business.barcodes.index') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('stockPermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.stocks.index', 'business.expired-products.index') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('partiesPermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ (Request::routeIs('business.parties.index') && request('type') == 'Customer') || (Request::routeIs('business.parties.create') && request('type') == 'Customer') || (Request::routeIs('business.parties.edit') && request('type') == 'Customer') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('addIncomePermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.incomes.index', 'business.income-categories.index') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('shippingPermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.shipping.index', 'business.shipping.create') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('orderSourcePermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.orderSource.index', 'business.orderSource.create', 'business.orderSource.edit') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('addExpensePermission'))
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.expense-categories.index', 'business.expenses.index') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
                ...
                @if (auth()->user()->role != 'staff' || visible_permission('reportsPermission'))
                    <li class="nav-item">
                        ...
                        <ul class="collapse">
                            ...
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.stock-reports.index') ? 'active' : '' }}" href="{{ route('business.stock-reports.index') }}">{{ __('Current Stock') }}</a></li>
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.due-reports.index') ? 'active' : '' }}" href="{{ route('business.due-reports.index') }}">{{ __('Customer Due') }}</a></li>
                            ...
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.loss-profit-reports.index') ? 'active' : '' }}" href="{{ route('business.loss-profit-reports.index') }}">{{ __('Loss & Profit') }}</a></li>
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.transaction-history-reports.index') ? 'active' : '' }}" href="{{ route('business.transaction-history-reports.index') }}">{{ __('Transaction') }}</a></li>
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.subscription-reports.index') ? 'active' : '' }}" href="{{ route('business.subscription-reports.index') }}">{{ __('Subscription Report') }}</a></li>
                            <li><a class="nav-link menu-link {{ Request::routeIs('business.expired-product-reports.index') ? 'active' : '' }}" href="{{ route('business.expired-product-reports.index') }}">{{ __('Expired Product') }}</a></li>
                        </ul>
                    </li>
                @endif
                ...
                @if (auth()->user()->role != 'staff')
                    <li class="nav-item">
                        <a class="nav-link menu-link menu-dropdown {{ Request::routeIs('business.ticketSystem.index', 'business.ticketSystem.create') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
