        ...
        <div class="card shadow-lg rounded-4 border-0">
            <div class="card-body p-4">
                <div class="table-header p-4 bg-primary text-white rounded-top-4 d-print-none">
                    <h4 class="mb-0 fw-bold">{{ __('Purchase Report List') }}</h4>
                </div>
                ...
                <div class="table-top-form p-4 bg-light rounded-bottom-4">
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        <form action="{{ route('business.purchase-reports.filter') }}" method="post" class="report-filter-form w-auto" table="#purchase-report-data">
                            @csrf
