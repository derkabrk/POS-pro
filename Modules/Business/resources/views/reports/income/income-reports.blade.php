        ...
        <div class="card shadow-lg rounded-4 border-0">
            <div class="card-body p-4">
                <div class="table-header p-4 bg-primary text-white rounded-top-4 d-print-none">
                    <h4 class="mb-0 fw-bold">{{ __('Income Report List') }}</h4>
                </div>
                ...
                <div class="table-top-form p-4 bg-light rounded-bottom-4">
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        <form action="{{ route('business.income-reports.filter') }}" method="post" class="report-filter-form w-auto" table="#income-reports-data">
                            @csrf
                    ...
                    <div class="table-top-btn-group d-print-none mt-3">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a href="{{ route('business.income-reports.csv') }}" class="btn btn-outline-secondary rounded-pill px-3">
                                    <img src="{{ asset('assets/images/logo/csv.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="{{ route('business.income-reports.excel') }}" class="btn btn-outline-success rounded-pill px-3">
