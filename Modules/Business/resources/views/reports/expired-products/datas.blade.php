...
<tr>
    ...
    <td class="{{ $product->expire_date < now()->toDateString() ? 'text-danger fw-bold' : '' }}">
    ...
    <td class="print-d-none">
        <div class="dropdown table-action">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="{{ route('business.products.edit', $product->id) }}" class="dropdown-item">
                        <i class="fal fa-edit"></i>
                        {{ __('Edit') }}
                    </a>
                </li>
                <li>
                    <a href="{{ route('business.products.destroy', $product->id) }}" class="confirm-action dropdown-item" data-method="DELETE">
