            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <div class="table-header d-flex justify-content-between align-items-center p-3">
                        <h4 class="mb-0">{{ __('Income Category List') }}</h4>
                        <a type="button" href="#income-categories-create-modal" data-bs-toggle="modal"
                            class="btn btn-primary rounded-pill {{ Route::is('admin.income-categories.create') ? 'active' : '' }}">
                ...
                <div class="delete-item d-none">
                    <div class="delete-item-show d-flex justify-content-between align-items-center p-3">
                        ...
                        <button data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#multi-delete-modal" data-url="{{ route('business.income-categories.delete-all') }}">{{ __('Delete') }}</button>
                    </div>
                </div>
