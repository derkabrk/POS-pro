            ...
            <div class="card" id="purchaseList">
                <div class="card-header border-0">
                    <div class="row align-items-center gy-3">
                        <div class="col-sm">
                            <h5 class="card-title mb-0">{{ __('Purchase List') }}</h5>
                        </div>
                        <div class="col-sm-auto">
                            <div class="d-flex gap-1 flex-wrap">
                                <!-- Add new purchase button if needed -->
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route('business.purchases.filter') }}" method="post" class="filter-form d-flex align-items-center gap-3" table="#purchases-data">
                        @csrf
                ...
                <div class="card-body pt-0">
                    <div class="table-responsive table-card" style="margin-top:20px;">
                        <table class="table table-nowrap mb-0" id="purchaseTable">
