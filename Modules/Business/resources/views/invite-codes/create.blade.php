        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white rounded-top-4">
                    <h5 class="mb-0"><i class="ri-add-line me-1"></i> {{ __('Create Invite Code') }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('business.invite-codes.store') }}">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('business.invite-codes.index') }}" class="btn btn-outline-secondary rounded-pill px-4">{{ __('Cancel') }}</a>
