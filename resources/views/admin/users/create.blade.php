...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">{{ __('Add New Staff') }}</h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <img src="{{ asset('assets/images/icons/upload.png') }}" id="image" class="table-img" style="max-width: 40px; max-height: 40px;">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12 text-center mt-4">
                        <a href="{{ route('admin.users.index') }}" class="btn btn-light me-3">{{__('Cancel')}}</a>
