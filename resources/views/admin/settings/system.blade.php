...
<div class="container-fluid">
    <div class="card shadow-sm mb-4">
        <div class="card-header">
            <h4 class="mb-0">{{ __('System Settings') }}</h4>
        </div>
        <div class="card-body">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item">
                                        <a href="#app" id="home-tab4" class="nav-link active" data-bs-toggle="tab">{{ __('App') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#Drivers" class="nav-link" data-bs-toggle="tab">{{ __('Drivers') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#storage" class="nav-link" data-bs-toggle="tab">{{ __('Storage Settings') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#mail-configuration" class="nav-link" data-bs-toggle="tab">{{ __('Mail Configuration') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#other" class="nav-link" data-bs-toggle="tab">{{ __('Others') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="button-group text-center mt-4">
                                                <button class="btn btn-primary m-2 submit-btn">{{ __('Update') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
