...
@endsection
@section('script')
<script src="{{ URL::asset('libs/list.js/list.min.js') }}"></script>
<script src="{{ URL::asset('libs/list.pagination.js/list.pagination.min.js') }}"></script>

<!--ecommerce-customer init js -->
<script src="{{ URL::asset('js/pages/ecommerce-order.init.js') }}"></script>
