...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Shyftcom - Admin & Dashboard Template</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ get_option('general')['favicon_url'] ?? asset('assets/images/logo/favicon.png') }}">
