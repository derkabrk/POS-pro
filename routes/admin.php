...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
   ...
   // Shipping Companies
    ...
    Route::resource('shipping-companies',ADMIN\AcnooShippingCompaniesController::class)->except('show');
    Route::post('shipping-companies/filter', [ADMIN\AcnooShippingCompaniesController::class, 'acnooFilter'])->name('shipping-companies.filter');
    ...
    Route::resource('ticket-system', ADMIN\TicketSystemController::class);


    Route::get('/ticket-categories', ADMIN\TicketCategoriesController::class, 'index');
    Route::post('/ticket-categories', ADMIN\TicketCategoriesController::class, 'store');
